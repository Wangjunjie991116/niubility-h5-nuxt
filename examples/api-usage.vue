<template>
  <div class="api-example">
    ...
    <section>
      ...
      <button
        :disabled="requestData.loading.value"
        @click="requestData.execute"
      >
      ...
      <p v-if="requestData.error.value" class="error">
        错误: {{ requestData.error.value.message }}
      </p>
    </section>
    ...
    <section>
      ...
      <button :disabled="pagination.loading.value" @click="pagination.loadMore">
        加载更多
      </button>
